...
def chunk_batch(func, chunk_size, move_to_cpu, rays, group_id, group_id_dict, stage, *args, **kwargs):
    B = rays.shape[0]
    ...
    for i in range(0, B, chunk_size):
        ...
        # Call the function with rays and other unchanged arguments
        out_chunk = func(chunk_rays, group_id, group_id_dict, stage, *args, **kwargs)
    ...
    # Move merged tensors to CPU
    out = {k: torch.cat(v, dim=0).cpu() for k, v in out.items()}
